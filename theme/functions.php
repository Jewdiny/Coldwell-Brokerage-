...
function cb_get_communities() {
    return [
        ...
        'bentwood' => [
            ...
            'description' => "Bentwood Country Club Estates is San Angelo's most distinguished gated luxury community, built around an 18-hole championship golf course designed by the legendary Tom Fazio firm. Homes in Bentwood range from elegant 3,000-square-foot custom builds to sprawling 6,000+ sqft estates with pools, guest casitas, and golf-course frontage. Residents enjoy access to the Bentwood Country Club's golf, tennis, swimming, and fitness amenities, plus the security of a 24-hour gated entrance and a deeply established luxury neighborhood feel. The Bentwood zip code (76904) consistently records San Angelo's highest median sale prices, and homes here are typically zoned to Central High School within San Angelo ISD. For buyers seeking the area's most prestigious address — with golf, social club lifestyle, and a long history of luxury home appreciation — Bentwood is the answer.",
