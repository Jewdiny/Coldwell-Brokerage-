<?php
/**
 * Homepage Template — Cinematic Vertical-Scroll Experience
 *
 * The homepage is built as a sequence of full-viewport "scenes" inside a
 * .cb-scroll-stage. On capable desktops (html.cb-cinematic) home.js pins each
 * scene and scrubs scroll-linked transitions over a fixed background canvas.
 * Without JS / on mobile / with reduced-motion it degrades to a clean stacked
 * layout where each scene carries its own gradient atmosphere. All dynamic
 * content (live MLS listings, stat counters, communities, testimonials, blog)
 * is server-rendered so it stays crawlable and visible with zero JS.
 *
...
cb_set_seo_meta([
    ...
    'description' => 'Search live San Angelo MLS listings, luxury homes, and Concho Valley real estate. Coldwell Banker Legacy — your local experts since 2000. (325) 944-9559.',
    'canonical'   => home_url('/'),
    'og_image'    => CB_THEME_URI . '/assets/images/hero-default.jpg',
]);
 ...
 * no code change needed. Until then, scenes render with their gradient only.
 */
 ...
 * that scene plays live footage behind its content — turning the homepage into
 * a scroll-driven film. A matching photo (same name) is used as the poster.
 */
